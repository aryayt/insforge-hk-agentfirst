  ...
  return (
    ...
    >
        ...
        <div className="widget-card widget-stack">
          ...
          <div className="meta-grid">
            <div className="meta-block">
              ...
              <p className="meta-value mono">{product.slug}</p>
            </div>
            <div className="meta-block">
      ...
      <p className="footer-note">
        Best next step: call <span className="mono">create_design</span> with a prompt, then <span className="mono">add_to_cart</span> using one of the SKUs above.
      </p>
    </WidgetShell>
  );
}
